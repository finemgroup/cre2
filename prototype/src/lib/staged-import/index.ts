...
export const mockUploadFiles: MockUploadFile[] = [
  ...
  { id: 't12', name: 'T12.pdf', type: 'T12', status: 'extracting', progress: 64, issue: 'Scan quality requires review.' },
];
...
export const mockCandidateFields: CandidateField[] = [
  ...
  { field: 'Vacancy', value: '4.5%', source: 'Rent roll', confidence: 'Medium', issue: 'Needs rent-roll citation confirmation.' },
