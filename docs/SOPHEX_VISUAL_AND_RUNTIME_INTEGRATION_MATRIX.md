...
| `/export/:id`         | `prototype/src/pages/ExportPage.tsx`   | Public export gate  | A            | C             | Mock-only export readiness cockpit with deterministic fixture states, consent/source-rights/reviewer/section gates, blocker register, disabled generate action, report-state continuity, boundary banners, and visual snapshot posture.                                                              | Keep blocker hierarchy reviewed as more receipt states are designed. | Idempotent receipts, source-rights filtering, legal consent, governed export. | Blocked     |
