...
| `/report/:id` | `prototype/src/pages/ReportPage.tsx` | Public report | A | B | `SOPHEX-REPORT-001` Stitch-inspired reporting cockpit: Public Intelligence posture, "Not an appraisal" copy, advisory/model-inferred range, source coverage, warning/gap register, authority labels, draft report sections, static status rail, and gated export footer. | Trust/copy pass, fixture-depth states, and UX coherence pass across property → comps → report → export. | Permission-filtered source bundles, section review state, sandbox contract parity, and export receipts remain future-gated. | Mostly done |
| `/export/:id` | `prototype/src/pages/ExportPage.tsx` | Public export gate | A | C | Consent, blockers, mock receipt, manifest, boundary banners, export gate adapter shell, visual snapshot. | Keep blocker hierarchy reviewed as more receipt states are designed. | Idempotent receipts, source-rights filtering, legal consent, governed export. | Blocked |
...
| `SOPHEX-REPORT-001` | P0 | Public reporting golden path | Unify the public reporting cockpit around evidence-backed advisory valuation, visible source posture, warning/gap register, draft section states, and blocked export posture. | `prototype/src/pages/ReportPage.tsx`, `prototype/src/index.css`, `docs/closeouts/SOPHEX_REPORTING_GOLDEN_PATH_STITCH_UI_2026-05-26.md` | Product identity/tool authority gate | `/report/:id` clearly communicates Public Intelligence, "Not an appraisal," advisory/model-inferred range, source coverage, blockers/warnings, authority labels, draft report states, export gated/disabled, and prototype-only language. | Draft PR #3 |
...
| `SOPHEX-REPORT-001` | Type-check/build passed | Pending broader suite | Clean on touched files; repo lint has pre-existing spatial hook issue | Pending PR review | Pending visual review | Responsive stack added | N/A | Required | Required | Draft PR #3 closeout |
...
| 2026-05-26 | `SOPHEX-REPORT-001` | Draft PR #3 implements Stitch-inspired public reporting golden path cockpit and tracks the follow-up trust/copy, fixture depth, UX coherence, and later sandbox contract gates. | `prototype/src/pages/ReportPage.tsx`, `prototype/src/index.css`, `docs/closeouts/SOPHEX_REPORTING_GOLDEN_PATH_STITCH_UI_2026-05-26.md` |
