...
13. [UX_MOTION_TO_SOPHEX_HARVEST_PACKET_PROVISIONAL.md](UX_MOTION_TO_SOPHEX_HARVEST_PACKET_PROVISIONAL.md)
14. [SISTER_PROJECT_SOURCE_MAP.md](SISTER_PROJECT_SOURCE_MAP.md)
15. [SOPHEX_REFERENCE_PATHS.md](SOPHEX_REFERENCE_PATHS.md)
16. [SOPHEX_CONCEPTUAL_CONTRACTS.md](SOPHEX_CONCEPTUAL_CONTRACTS.md)
17. [TRUST_AND_PERMISSIONS_MODEL.md](TRUST_AND_PERMISSIONS_MODEL.md)
18. [EVIDENCE_AND_OBSERVATION_MODEL.md](EVIDENCE_AND_OBSERVATION_MODEL.md)
19. [DOCUMENT_INGESTION_MODEL.md](DOCUMENT_INGESTION_MODEL.md)
20. [VALUATION_REPORTING_PRODUCT.md](VALUATION_REPORTING_PRODUCT.md)
21. [FRONTEND_UX_INHERITANCE.md](FRONTEND_UX_INHERITANCE.md)
22. [MOTION_AND_INTERACTION_GUIDELINES.md](MOTION_AND_INTERACTION_GUIDELINES.md)
23. [SOPHEX_TRUST_UI_GUIDELINES.md](SOPHEX_TRUST_UI_GUIDELINES.md)
24. [SOPHEX_MVP0_SCREEN_MAP.md](SOPHEX_MVP0_SCREEN_MAP.md)
25. [FUTURE_SCHEMA_CONCEPTS.md](FUTURE_SCHEMA_CONCEPTS.md)
26. [AGENT_WORKFLOW_CONCEPTS.md](AGENT_WORKFLOW_CONCEPTS.md)
27. [CRE_PLATFORM_ALIGNMENT.md](CRE_PLATFORM_ALIGNMENT.md)
28. [FINEM_FABRICATOR_ALIGNMENT.md](FINEM_FABRICATOR_ALIGNMENT.md)
29. [DATA_PRIVACY_AND_MARKETPLACE_RULES.md](DATA_PRIVACY_AND_MARKETPLACE_RULES.md)
30. [INITIAL_ROADMAP.md](INITIAL_ROADMAP.md)
31. [NON_GOALS.md](NON_GOALS.md)
32. [CURSOR_PROJECT_SETUP.md](CURSOR_PROJECT_SETUP.md)
33. [OPEN_QUESTIONS.md](OPEN_QUESTIONS.md)
34. [GIT_AND_REMOTE_SETUP.md](GIT_AND_REMOTE_SETUP.md)
