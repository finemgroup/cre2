...
Superseded drafts (archive only): `CRE_TO_SOPHEX_HARVEST_PACKET.md`, `CRE_TO_SOPHEX_HARVEST_PACKET_PROVISIONAL.md`, `FABRICATOR_TO_SOPHEX_HARVEST_PACKET.md`, `CONTENT_ENGINE_TO_SOPHEX_HARVEST_PACKET.md`, `UX_MOTION_TO_SOPHEX_HARVEST_PACKET.md`, `UX_MOTION_TO_SOPHEX_HARVEST_PACKET_PROVISIONAL.md`.
