...
No sending or marketing automation may operate without consent, suppression/unsubscribe handling, idempotency, auditability, and operator approval. This applies to email, CRM sync, provider sends, partner notifications, and queue-driven workflows.
